...
public interface EnvironmentContextTesting<C extends EnvironmentContext> extends ContextTesting<C> {
    ...
    default <T> void environmentValueAndCheck(final C context,
